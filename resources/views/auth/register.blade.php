...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card">
                <div class="text-center btn btn-dark btn-block">{{ __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Masukan Password" name="password" required autocomplete="new-password">
    ...
    <h3><center><div class="text-center btn btn-dark btn-block col-md-7">Sistem Informasi Wisata</div></center></h3>
</div>
</div>
@endsection
